      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Velg dine favorittklasser og bygg din egen danseopplevelse. Vi
            tilbyr flexible pakker med automatisk familierabatt.
          </p>
          ...
          {safeCartSummary.itemCount === 0 && (
            <div className="mt-6 inline-flex items-center px-4 py-2 bg-purple-100 text-purple-800 rounded-full text-sm">
              ...
              <span className="ml-1">
                Automatisk familierabatt når du legger til flere barn!
              </span>
            </div>
          )}
        </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Legg til første student med full pris. Ingen familierabatt
                    ennå.
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Familierabatt aktiveres automatisk! 15-50% rabatt basert på
                    antall klasser.
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">
                    Systemet foreslår etternavn og grupperer automatisk
                    familiemedlemmer.
                  </p>
                </div>
              </div>
        ...
        {safeCartSummary.itemCount > 0 &&
          safeCartSummary.items.some((item) => item.isSecondDancerInFamily) && (
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    <span className="font-bold text-green-600">
                      {(safeCartSummary.totalDiscount / 100).toFixed(0)} kr
                    </span>{" "}
                    med familierabatten
                  </p>
                  <div className="grid grid-cols-2 gap-4 max-w-md mx-auto text-sm">
                    <div className="bg-white rounded-lg p-3">
                      ...
                      <div className="text-gray-600 line-through">
                        {(safeCartSummary.originalTotal / 100).toFixed(0)} kr
                      </div>
                    </div>
                    <div className="bg-white rounded-lg p-3">
                      <div className="font-semibold text-gray-900">
                      ...
                      <div className="text-green-600 font-bold">
                        {(safeCartSummary.total / 100).toFixed(0)} kr
                      </div>
                    </div>
                  </div>
                </div>
