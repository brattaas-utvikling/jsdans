    ...
    <footer className="bg-surface-dark dark:bg-gray-900 text-white pt-16 pb-4 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
            <div className="flex items-center gap-2 mb-8">
              <img src={logo} alt="Urban Studios Logo" className="h-36 md:h-40 w-auto invert mx-auto" />
            </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 mb-12">
          <div className="flex flex-col items-start">

            {/* Tagline med blå/cyan gradient */}
            <p className="text-transparent bg-clip-text bg-hero-gradient dark:bg-energy-gradient mb-6 font-montserrat font-medium">
              {STUDIO_INFO.tagline}
            </p>

          {/* Studio info */}
            <p className="text-gray-300 dark:text-gray-200 mb-4 max-w-xs font-montserrat leading-relaxed">
              Vi tilbyr et bredt spekter av danseklasser for alle aldre og
              ferdighetsnivåer, fra nybegynnere til avanserte dansere.
            </p>
