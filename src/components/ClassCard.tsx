...
const colorMap: Record<ColorName, ColorClasses> = {
  ...
  'amber': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-amber-50 dark:hover:bg-amber-900/30 hover:text-amber-800 dark:hover:text-amber-200'
  },
  'yellow': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-yellow-50 dark:hover:bg-yellow-900/30 hover:text-yellow-800 dark:hover:text-yellow-200'
  },
  'lime': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-lime-50 dark:hover:bg-lime-900/30 hover:text-lime-800 dark:hover:text-lime-200'
  },
  'green': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-green-50 dark:hover:bg-green-900/30 hover:text-green-800 dark:hover:text-green-200'
  },
  'emerald': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-emerald-50 dark:hover:bg-emerald-900/30 hover:text-emerald-800 dark:hover:text-emerald-200'
  },
  'teal': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-teal-50 dark:hover:bg-teal-900/30 hover:text-teal-800 dark:hover:text-teal-200'
  },
  'cyan': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-cyan-50 dark:hover:bg-cyan-900/30 hover:text-cyan-800 dark:hover:text-cyan-200'
  },
  'sky': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-sky-50 dark:hover:bg-sky-900/30 hover:text-sky-800 dark:hover:text-sky-200'
  },
  'blue': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-blue-50 dark:hover:bg-blue-900/30 hover:text-blue-800 dark:hover:text-blue-200'
  },
  'indigo': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-indigo-50 dark:hover:bg-indigo-900/30 hover:text-indigo-800 dark:hover:text-indigo-200'
  },
  'violet': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-violet-50 dark:hover:bg-violet-900/30 hover:text-violet-800 dark:hover:text-violet-200'
  },
  'purple': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-purple-50 dark:hover:bg-purple-900/30 hover:text-purple-800 dark:hover:text-purple-200'
  },
  'fuchsia': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-fuchsia-50 dark:hover:bg-fuchsia-900/30 hover:text-fuchsia-800 dark:hover:text-fuchsia-200'
  },
  'pink': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-pink-50 dark:hover:bg-pink-900/30 hover:text-pink-800 dark:hover:text-pink-200'
  },
  'rose': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-rose-50 dark:hover:bg-rose-900/30 hover:text-rose-800 dark:hover:text-rose-200'
  },
  'slate': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-slate-50 dark:hover:bg-slate-900/30 hover:text-slate-800 dark:hover:text-slate-200'
  },
  'gray': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-gray-50 dark:hover:bg-gray-900/30 hover:text-gray-800 dark:hover:text-gray-200'
  },
  'zinc': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-zinc-50 dark:hover:bg-zinc-900/30 hover:text-zinc-800 dark:hover:text-zinc-200'
  },
  'neutral': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-neutral-50 dark:hover:bg-neutral-900/30 hover:text-neutral-800 dark:hover:text-neutral-200'
  },
  'stone': {
    ...
    buttonText: 'text-white',
    buttonHover: 'hover:bg-stone-50 dark:hover:bg-stone-900/30 hover:text-stone-800 dark:hover:text-stone-200'
  }
};
