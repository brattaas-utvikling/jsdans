...
const PulseSpinner: React.FC<{ size: string; color: string }> = ({
  ...
  return (
    <div className="relative">
      ...
      />
      <div
        className={cn("absolute inset-0 rounded-full border-2", baseColor)}
      />
    </div>
  );
};
...
const DanceSpinner: React.FC<{ size: string; color: string }> = ({
  size,
  color,
}) => (
  <div className="relative">
...
const MinimalSpinner: React.FC<{ size: string; color: string }> = ({
  size,
  color,
}) => {
  const borderColor =
...
export const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({
  ...
  return (
    ...
    >
      ...
      {text && (
        <p
          className={cn("font-medium animate-pulse", colorClass, textSizeClass)}
        >
          {text}
        </p>
      )}
...
export const PageLoading: React.FC<{
  ...
  <div className="min-h-screen bg-gray-50 flex items-center justify-center">
    <div className="text-center space-y-6 max-w-md px-4">
      <LoadingSpinner size="xl" variant="dance" color="primary" />
