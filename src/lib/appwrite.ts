...
export const COLLECTIONS = {
  DANCE_CLASSES:
    import.meta.env.VITE_DANCE_CLASSES_COLLECTION_ID || "dance_classes",
  DANCE_CLASSES_CAROUSEL:
    import.meta.env.VITE_DANCE_CLASSES_CAROUSEL_COLLECTION_ID ||
    "dance_classes_carousel",
  SCHEDULES: import.meta.env.VITE_SCHEDULES_COLLECTION_ID || "schedules",
  PRICING_PACKAGES:
    import.meta.env.VITE_PRICING_PACKAGES_COLLECTION_ID || "pricing_packages",
  ...
  FAMILY_GROUPS:
    import.meta.env.VITE_FAMILY_GROUPS_COLLECTION_ID || "family_groups",
  ...
  ENROLLMENTS: import.meta.env.VITE_ENROLLMENTS_COLLECTION_ID || "enrollments",
} as const;
