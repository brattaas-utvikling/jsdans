...
/**
 * ✅ Final:
 * - Rom (Sal 1 / Sal 2) = statisk (alltid synlig)
 * - Dager = dynamisk (Fredag skjules hvis ingen data) på både mobil + desktop
 */
export default function SchedualPage() {
  ...
  /**
   * ✅ Dager (dynamisk): brukes både av mobil og desktop.
   * Skjuler f.eks. "Fredag" hvis ingen schedules har day="Fredag"
   */
  const visibleDays = useMemo(() => {
    ...
    // fallback hvis noe er rart / tomt
    return ordered.length ? ordered : DAYS_OF_WEEK;
  }, [schedules]);

  /**
   * ✅ Hold selectedDay gyldig hvis dagen forsvinner (f.eks. Fredag fjernes)
   */
  useEffect(() => {
  ...
  /**
   * Mobile: schedules filtrert på selectedDay + theme (mobile view)
   */
  ...
  /**
   * Index for mobile (room -> start_time -> schedule)
   */
  ...
  /**
   * Full index for desktop (day -> room -> start_time -> schedule)
   */
  ...
  /**
   * Desktop RoomSelector: statisk basert på STUDIO_ROOMS (alltid Sal 1 + Sal 2)
   */
  const RoomSelector = () => (
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-surface-dark">
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-brand-50/80 to-surface-muted dark:from-brand-900/10 dark:to-surface-dark-muted pt-24 pb-4 relative overflow-hidden">
      ...
      {/* Timeplan */}
      <section className="py-4 pb-8 px-4 bg-gradient-to-br from-brand-50/80 to-surface-muted dark:from-brand-900/10 dark:to-surface-dark-muted lg:pb-8">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            {/* ✅ Day selector - mobile (dynamisk, Fredag kan forsvinne) */}
              ...
              {selectedRooms.length === 0 ? (
                ...
                <div className="overflow-x-auto">
                  ...
                  >
                    ...
                    {/* ✅ Desktop days: dynamisk (Fredag kan forsvinne) */}
                    {visibleDays.map((day) =>
