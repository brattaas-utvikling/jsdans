        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 font-montserrat leading-relaxed">
              Hold deg oppdatert på alt som skjer hos Urban Studios! Fra nye
              kurs til spennende events og inspirerende danse-historier.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            >
              <div className="max-w-6xl mx-auto">
                <Link to={`/nyheter/${featuredArticle.$id}`}>
                  <div
                    className="relative h-[500px] md:h-[600px] rounded-3xl overflow-hidden shadow-brand-xl 
                    ...
                    <div className="absolute inset-0 z-20 flex flex-col justify-between p-6 md:p-10">
                      ...
                      <div className="space-y-6 max-w-4xl">
                        <div className="space-y-4">
                          <h3
                            className="font-bebas text-bebas-2xl md:text-bebas-3xl lg:text-bebas-4xl 
              ...
              {regularArticles.map((article, index) => (
                ...
                >
                  <Link to={`/nyheter/${article.$id}`}>
                    <div
                      className="relative h-96 w-full rounded-2xl overflow-hidden shadow-brand hover:shadow-brand-lg 
