...
export const homepageSchemaModalBased = {
  ...
  "description": "Profesjonelt dansestudio i Kongsvinger med ballet, hip-hop, jazz, moderne dans og dansekompani for alle aldre og nivåer",
    ...
    "itemListElement": [
      ...
      // BALLET
      {
        ...
        "itemOffered": {
          ...
          "description": "Klassisk ballet opplæring for alle aldre og nivåer i Kongsvinger",
      ...
      // HIP-HOP
      {
        ...
        "itemOffered": {
          ...
          "description": "Hip-hop dans og urban styles for alle nivåer i Kongsvinger",
      ...
      // STYRKE OG TØY
      {
        ...
        "itemOffered": {
          "@type": "Service",
          "name": "Styrke og tøy",
          "description": "Fysisk trening tilpasset dansere - styrke og fleksibilitet",
  ...
  "offers": [
    ...
    },
    {
      "@type": "Offer",
      "name": "Familierabatt",
      "description": "50% rabatt for danser nr 2 som danser 3 eller flere klasser",
      "priceSpecification": {
        "@type": "UnitPriceSpecification",
        "priceCurrency": "NOK",
